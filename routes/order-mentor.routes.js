...
router.get('/suitable0rders', authMiddleware,async (req, res) => {
    try {
        ...
        'SELECT "id_order", "student_id","direction", "experience", "city", "sex","type" ,"priceFrom", "priceTo", "ageFrom", "ageTo", "suggestions", "datetime" ' +
...
router.get('/responses', authMiddleware, async (req,res) => {
    try {
        ...
        'SELECT "id_response", "order_id", "student_id","mentor_id", "direction", "experience", "city", "sex", type, "priceFrom", "priceTo", "ageFrom", "ageTo", suggestions ' +
